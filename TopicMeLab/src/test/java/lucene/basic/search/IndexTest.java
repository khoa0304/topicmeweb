...
public class IndexTest {
	...
	public void testBasicIndex() {
		...
		//String docPath = "D:/KhoaBackupDoNoDelete/EBooks-2016-03-08/EBooks/Manning.Lucene.in.Action.2nd.Edition.Jun.2010.MEAP.pdf";
	
		String docPath ="D:/OpenSource/lucene/Note.txt";
	...
	public void indexDocs(final IndexWriter writer, Path path) throws IOException {
		...
		//	indexTest1(writer, path, Files.getLastModifiedTime(path).toMillis());
	...
	public void indexTest1(IndexWriter writer, Path file, long lastModified) throws IOException {
		
		for(String[] st : SearchTest.contents){
			
			
			// make a new, empty document
			Document doc = new Document();
	
			Field pathField = new StringField("path", st[0], Field.Store.YES);
			doc.add(pathField);
	
			doc.add(new LongPoint("modified", System.currentTimeMillis()));
	
			doc.add(new TextField("contents",st[1],Field.Store.YES));
...
//					new BufferedReader(new InputStreamReader(stream, StandardCharsets.UTF_8))));
			...
			doc.add(new TextField("contents"," Today is my happy day. I love my life",Field.Store.YES));
